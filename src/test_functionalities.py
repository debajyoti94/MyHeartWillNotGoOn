...
class TestFunctionality:
    ...
    def test_plot_null_values(self):
        ...
        assert (
            True
            if os.path.isfile(titanic_train_set) and os.path.isfile(titanic_test_set)
            else False
        )
    ...
    def test_cleaning_data(self):
        ...
        assert True if X_train.shape == (891, 5) and Y_train.shape == (891,) else False
